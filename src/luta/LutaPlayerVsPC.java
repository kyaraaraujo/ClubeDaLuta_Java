...
public class LutaPlayerVsPC {

    public void combate(LutadorPlayer lutador1, LutadorAutomatico lutador2){
        ...
        if(lutador1.getVitorias() == lutador2.getVitorias()){
            ...
            System.out.println("Lutador(a) " + lutador1.getNome() + " é o/ detentor(a) do cinturarão com "
